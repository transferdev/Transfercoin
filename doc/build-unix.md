...
memory available when compiling IonCoin Core. With 512MB of memory or less
...
# Configure IonCoin Core to use our own-built instance of BDB
cd $ION_ROOT
./autogen.sh
...
2) The release is built with GCC and then "strip iond" to strip the debug
