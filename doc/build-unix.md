...
memory available when compiling TransferCoin Core. With 512MB of memory or less
...
Build requirements:
    ...
    sudo apt-get install build-essential libtool automake autotools-dev autoconf pkg-config libssl-dev libgmp-dev libevent-dev bsdmainutils
...
# Configure TransferCoin Core to use our own-built instance of BDB
cd $TRANSFER_ROOT
./autogen.sh
